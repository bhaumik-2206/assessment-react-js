...
const Home = () => {
    ...
    useEffect(() => {
        ...
        setMedicineData(groupByData);
        // Set initial Medicine Data
        let todayData = groupByData[new Date().toDateString()] || [];
        ...
        if (period === "am") {
            ...
            let index = Object.values(dosageTime).findIndex((ele) => {
                ...
                if (Number(hours) === 12) {
                    ...
                    console.log(start, end, Number(hours) + 12)
